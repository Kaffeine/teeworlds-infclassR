...
MACRO_CONFIG_INT(InfFirstInfectedLimit, inf_first_infected_limit, 2, 0, 64, CFGFLAG_SERVER, "The number of initially infected players")
...
MACRO_CONFIG_INT(InfEnableElectrician, inf_enable_electrician, 1, 0, 1, CFGFLAG_SERVER, "Makes the electrician class available")
