...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_LIGHTNING_LASER, GetFireDelay(INFWEAPON_LASER));
	...
	SetAmmoRegenTime(INFWEAPON_LIGHTNING_LASER, 7000);
	...
	SetMaxAmmo(INFWEAPON_LIGHTNING_LASER, 10);
...
void CServer::Login(int ClientID, const char *pUsername, const char *pPassword)
{
	...
	Console()->Print(IConsole::OUTPUT_LEVEL_DEBUG, "registration", "login");
}
